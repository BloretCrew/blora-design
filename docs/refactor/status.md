...
**Phase 10：预发布 / RC 收口** - 🔄 **RC 门禁已完成，待正式 RC tag**（`2.0.0-beta.1` 已发布 · stable-core API 已冻结）
...
| Phase 10：预发布 | 🔄 RC 门禁完成 | `2.0.0-beta.1` 已发布；Firefox/WebKit 87/87，npm/CDN/CSP/SSR/rollback 证据已记录；待正式 RC tag |
