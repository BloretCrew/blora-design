  ...
  render: () => html`
    <div class="blora-stack" style="gap: var(--blora-space-4); max-width: 480px;">
      <div class="blora-chat">
        <span class="blora-avatar blora-avatar--info blora-chat__avatar"
          style="width:2.5em;height:2.5em;border-radius:50%;background:var(--blora-color-status-info);color:var(--blora-color-text-on-accent);display:grid;place-items:center;font-weight:600;flex:none;">A</span>
      ...
      <div class="blora-chat blora-chat--end">
        <span class="blora-avatar blora-avatar--primary blora-chat__avatar"
          style="width:2.5em;height:2.5em;border-radius:50%;background:var(--blora-color-action-primary-default);color:var(--blora-color-text-on-accent);display:grid;place-items:center;font-weight:600;flex:none;">B</span>
        <div class="blora-chat__content">
