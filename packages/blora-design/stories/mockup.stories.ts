  ...
  render: () => html`
    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: var(--blora-space-5);">
      ...
      <div class="blora-mockup blora-mockup--code" role="region" aria-label="终端输出示例">
        <pre
          class="blora-mockup__line"
          data-prefix="$"
        ><code>npm install @bloret-crew/blora-design</code></pre>
        <pre
          class="blora-mockup__line blora-mockup__line--muted"
          data-prefix=">"
        ><code>installing packages…</code></pre>
        <pre
          class="blora-mockup__line blora-mockup__line--success"
          data-prefix="✓"
        ><code>added 12 packages in 1.2s</code></pre>
        <pre class="blora-mockup__line" data-prefix="$"><code>npx blora init</code></pre>
        <pre
          class="blora-mockup__line blora-mockup__line--info"
          data-prefix="✓"
        ><code>project ready</code></pre>
      </div>
      ...
      <div class="blora-mockup blora-mockup--phone" aria-label="手机预览">
        ...
        <div class="blora-mockup__display">
          <div
            class="blora-mockup__display-body"
            style="display: flex; flex-direction: column; gap: var(--blora-space-3);"
          >
            <div>
            ...
            <div
              style="padding: var(--blora-space-3); border-radius: var(--blora-radius-sm); background: var(--blora-color-surface-raised); border: 1px solid var(--blora-color-border-subtle);"
            >
              <div style="font-weight: 600; font-size: var(--blora-text-sm);">今日任务</div>
              <div class="blora-text-muted" style="font-size: var(--blora-text-xs);">
                3 项待处理
              </div>
            </div>
            <button
