...
describe("generated outputs", () => {
  it("generates public light and dark semantic CSS", () => {
    ...
    expect(darkCss).not.toMatch(/^\[data-blora-color-scheme="dark"\]/m);
    expect(lightCss).not.toContain('[data-blora-color-scheme="light"]');
  ...
  it("generates the six shipping palette selectors", () => {
    ...
    expect(themesCss).not.toContain('data-blora-theme="ocean"');
