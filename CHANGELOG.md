...
- Stopped the BBBS replica feed items from drawing a thick ring on pointer focus, and inlined the keyboard focus ring so the feed list's clipped edges no longer cut it off on the left and right.
